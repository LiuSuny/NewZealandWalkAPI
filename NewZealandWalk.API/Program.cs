...
//config our logger using Serilog
var logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.File("Logs/NewzealandWalks_Log.txt", rollingInterval: RollingInterval.Minute)
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "NewZealand Walks API", Version = "v1" });
...
builder.Services.AddDbContext<NewZealandWalksAuthDbContext>(options =>
{
